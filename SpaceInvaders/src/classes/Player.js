import {INITIAL_FRAMES, PATH_ENGINE_IMAGE, PATH_ENGINESPRITES_IMAGE, PATH_SPACESHIP_IMAGE } from "../utils/constants.js";
...
class Player {
    constructor(canvasWidth , canvasHeight){
        ...
        this.engineSprites = this.getImage(PATH_ENGINESPRITES_IMAGE);
        this.sx = 0
